...
wget https://github.com/shoesi1109/Termux_XFCE/raw/main/conky.tar.gz
...
pd login ubuntu --shared-tmp -- env DISPLAY=:1.0 wget https://github.com/shoesi1109/Termux_XFCE/raw/main/mesa-vulkan-kgsl_24.1.0-devel-20240120_arm64.deb 
...
wget https://github.com/shoesi1109/Termux_XFCE/raw/main/ubuntu_etc.sh
